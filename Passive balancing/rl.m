...
mdl = "Cell_Balancing"; % name of the model
AGENT_FNAME = "Agent.mat"; % score of 1400
...
%     case "TrainRL"
    ...
    Tsim = 160; %[s] % override simulation time to make it faster?
    % Ts; % sample time        
    maxepisodes = 5;
    ...
    env = rlSimulinkEnv(mdl,mdl + "/RL/RL Agent",observationInfo,actionInfo);
